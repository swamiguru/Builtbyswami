...
// Compact date for the sub-nav pills — "Jul 27" rather than formatNoteDate's
// "Jul 27, 2026", so "Previous · Jul 27" still fits a 48px-tall bar.
          ...
          <div className="flex items-center gap-1">
            {older ? (
              <Link
                ...
                title={`Previous note: ${older.title}`}
